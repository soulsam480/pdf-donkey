...
import { Body, Controller, Get, Post, Redirect, Req, Res, UseBefore } from 'routing-controllers';
...
export class userController {
  ...
  @Post('/login')
  loginUser(@Body() loginDto: { password: string; email: string }, @Res() response: Response) {
